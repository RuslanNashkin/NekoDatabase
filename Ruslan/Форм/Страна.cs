...
{
    public partial class Страна : Form
    {
        public Страна()
        {
            InitializeComponent();
        ...
        private void stranaBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.stranaBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.lab2_1__1DataSet);

        }

        private void Страна_Load(object sender, EventArgs e)
        {
