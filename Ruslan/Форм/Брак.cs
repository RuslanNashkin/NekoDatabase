...
{
    public partial class Брак : Form
    {
        public Брак()
        {
            InitializeComponent();
        ...
        private void brakBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.brakBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.lab2_1__1DataSet);

        }

        private void Брак_Load(object sender, EventArgs e)
        {
